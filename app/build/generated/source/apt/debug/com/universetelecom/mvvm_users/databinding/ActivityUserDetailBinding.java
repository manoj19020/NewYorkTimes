...
public class ActivityUserDetailBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private com.universetelecom.mvvm_users.viewModel.UserDetailViewModel mUserDetailViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.userDetailViewModel == variableId) {
            setUserDetailViewModel((com.universetelecom.mvvm_users.viewModel.UserDetailViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setUserDetailViewModel(@Nullable com.universetelecom.mvvm_users.viewModel.UserDetailViewModel UserDetailViewModel) {
    ...
    @Nullable
    public com.universetelecom.mvvm_users.viewModel.UserDetailViewModel getUserDetailViewModel() {
    ...
    protected void executeBindings() {
        ...
        com.universetelecom.mvvm_users.viewModel.UserDetailViewModel userDetailViewModel = mUserDetailViewModel;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.universetelecom.mvvm_users.viewModel.UserDetailViewModel.loadImage(this.mboundView2, userDetailViewModelProfileThumb);
    ...
    public static ActivityUserDetailBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ActivityUserDetailBinding>inflate(inflater, com.universetelecom.mvvm_users.R.layout.activity_user_detail, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ActivityUserDetailBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.universetelecom.mvvm_users.R.layout.activity_user_detail, null, false), bindingComponent);
    }
    @NonNull
