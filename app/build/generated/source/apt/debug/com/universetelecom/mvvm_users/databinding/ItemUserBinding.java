...
public class ItemUserBinding extends android.databinding.ViewDataBinding  {
    ...
    // variables
    @Nullable
    private com.universetelecom.mvvm_users.viewModel.ItemUserViewModel mUserViewModel;
    // values
    // listeners
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.userViewModel == variableId) {
            setUserViewModel((com.universetelecom.mvvm_users.viewModel.ItemUserViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setUserViewModel(@Nullable com.universetelecom.mvvm_users.viewModel.ItemUserViewModel UserViewModel) {
    ...
    @Nullable
    public com.universetelecom.mvvm_users.viewModel.ItemUserViewModel getUserViewModel() {
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeUserViewModel((com.universetelecom.mvvm_users.viewModel.ItemUserViewModel) object, fieldId);
        }
        return false;
    }
    private boolean onChangeUserViewModel(com.universetelecom.mvvm_users.viewModel.ItemUserViewModel UserViewModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        com.universetelecom.mvvm_users.viewModel.ItemUserViewModel userViewModel = mUserViewModel;
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.universetelecom.mvvm_users.viewModel.UserDetailViewModel.loadImage(this.imagePeople, userViewModelProfileThumb);
    ...
    public static class OnClickListenerImpl implements android.view.View.OnClickListener{
        private com.universetelecom.mvvm_users.viewModel.ItemUserViewModel value;
        public OnClickListenerImpl setValue(com.universetelecom.mvvm_users.viewModel.ItemUserViewModel value) {
            this.value = value;
    ...
    public static ItemUserBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.view.ViewGroup root, boolean attachToRoot, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return android.databinding.DataBindingUtil.<ItemUserBinding>inflate(inflater, com.universetelecom.mvvm_users.R.layout.item_user, root, attachToRoot, bindingComponent);
    }
    @NonNull
    ...
    public static ItemUserBinding inflate(@NonNull android.view.LayoutInflater inflater, @Nullable android.databinding.DataBindingComponent bindingComponent) {
        return bind(inflater.inflate(com.universetelecom.mvvm_users.R.layout.item_user, null, false), bindingComponent);
    }
    @NonNull
