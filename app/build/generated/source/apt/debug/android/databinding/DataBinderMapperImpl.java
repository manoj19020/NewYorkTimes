...
class DataBinderMapperImpl extends android.databinding.DataBinderMapper {
    ...
    public android.databinding.ViewDataBinding getDataBinder(android.databinding.DataBindingComponent bindingComponent, android.view.View view, int layoutId) {
        switch(layoutId) {
                case com.newyork.times.R.layout.activity_user_detail:
 {
                        final Object tag = view.getTag();
                        if(tag == null) throw new java.lang.RuntimeException("view must have a tag");
                    if ("layout/activity_user_detail_0".equals(tag)) {
                            return new com.newyork.times.databinding.ActivityUserDetailBinding(bindingComponent, view);
                    }
                        throw new java.lang.IllegalArgumentException("The tag for activity_user_detail is invalid. Received: " + tag);
                }
                case com.newyork.times.R.layout.activity_users:
 {
                        final Object tag = view.getTag();
                        if(tag == null) throw new java.lang.RuntimeException("view must have a tag");
                    if ("layout/activity_users_0".equals(tag)) {
                            return new com.newyork.times.databinding.ActivityUsersBinding(bindingComponent, view);
                    }
                        throw new java.lang.IllegalArgumentException("The tag for activity_users is invalid. Received: " + tag);
                }
                case com.newyork.times.R.layout.item_user:
 {
                        final Object tag = view.getTag();
                        if(tag == null) throw new java.lang.RuntimeException("view must have a tag");
                    if ("layout/item_user_0".equals(tag)) {
                            return new com.newyork.times.databinding.ItemUserBinding(bindingComponent, view);
                    }
        ...
        switch(code) {
            case 1706009867: {
                if(tag.equals("layout/activity_user_detail_0")) {
                    return com.newyork.times.R.layout.activity_user_detail;
                }
                break;
            }
            case -726691122: {
                if(tag.equals("layout/activity_users_0")) {
                    return com.newyork.times.R.layout.activity_users;
                }
                break;
            }
            case -1243181053: {
                if(tag.equals("layout/item_user_0")) {
                    return com.newyork.times.R.layout.item_user;
                }
                break;
            }
        }
